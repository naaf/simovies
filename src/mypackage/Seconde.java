...
public class Seconde extends Brain {
    ...
    @Override
    public void step() {
    System.out.println("enddirection " + endTaskDirection);
    System.out.println("direction " + getHeading() +  " " + isHeading(endTaskDirection));
...
//
	if ((isHeading(Parameters.EAST) && distX > Parameters.teamAMainBotRadius ) || (isHeading(Parameters.SOUTH) && distY > Parameters.teamAMainBotRadius )
		|| (isHeading(Parameters.WEST) && distX > Parameters.teamAMainBotRadius ) || (isHeading(Parameters.NORTH) && distY > Parameters.teamAMainBotRadius )) {
//	if (detectFront().getObjectType() != IFrontSensorResult.Types.WALL) {
    ...
    private boolean isHeading(double dir) {
    	System.out.println("sin " + Math.abs(Math.sin(getHeading() - dir)) + "cos " +  Math.abs(Math.cos(getHeading() - dir)) );
