...
public class Position {
	...
	if ((a.x < b.x + WIDTH && a.x + WIDTH > b.x) && (a.y < b.y + WIDTH && a.y + WIDTH > b.y)) {
	    return true;
	}
	return false;
    }
	...
	if (distance < (Parameters.teamAMainBotRadius * 2) * (Parameters.teamAMainBotRadius * 2)) {
	    return true;
	}
	return false;
    }
	...
	Position a = new Position(Parameters.teamAMainBot1InitX,Parameters.teamAMainBot1InitY);
	Position b = new Position(Parameters.teamAMainBot2InitX,Parameters.teamAMainBot2InitY);
