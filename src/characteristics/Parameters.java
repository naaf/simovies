...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = Parametrage.NOM_EQUIPE;
  public static final String teamAMainBotBrainClassName = Parametrage.MAIN_NOM_CLASS; //class given by name; is supposed to extends robotsimulator.Brain
  ...
  public static final String teamASecondaryBotBrainClassName = Parametrage.SECONDAIRE_NOM_CLASS; //class given by name; is supposed to extends robotsimulator.Brain
